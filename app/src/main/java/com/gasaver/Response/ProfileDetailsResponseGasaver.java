...
public class ProfileDetailsResponseGasaver {
    ...
    @SerializedName("data")
    @Expose
    private List<ProfileDetailsGasaver> data;

    public List<ProfileDetailsGasaver> getData() {
        return data;
    }

    public void setData(List<ProfileDetailsGasaver> data) {
        this.data = data;
    }

    public class ProfileDetailsGasaver {
